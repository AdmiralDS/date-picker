...
`},J={color:Y,shadow:Z,zIndex:O,name:"dark",shape:{borderRadiusKind:"Border radius 4"},currentLocale:"ru",locales:v,typography:H,fontFamily:"'VTB Group UI', sans-serif"},Q=""+new URL("VTBGroupUI-SemiBold-Wupg3RVc.ttf",import.meta.url).href,X=""+new URL("VTBGroupUI-Medium-CJW7SkqK.otf",import.meta.url).href,aa=""+new URL("VTBGroupUI-Regular-JWIonCWQ.otf",import.meta.url).href,ra=`
    @font-face {
    ...
    @font-face {
        font-family: 'VTB Group UI';
        src: url('${aa}') format('opentype');
        font-display: swap;
        font-weight: 400;
        font-style: normal;
        font-feature-settings: 'tnum' on, 'lnum' on, 'cv03' on, 'cv04' on;
    }
`;function ea(r){return i.jsx("style",{type:"text/css",children:ra,...r})}const na=`
:root,
.admiral-theme-light {
  /*
   * Color Primitives
...
`;function ia(r){return i.jsx("style",{type:"text/css",children:na,...r})}function oa(r){return i.jsx("style",{type:"text/css",children:ta,...r})}var E="x74zn71 x74zn70 _1n7iq150",b="_15ajfyb0";const{definePreview:Wa}=__STORYBOOK_MODULE_PREVIEW_API__;var B="DARK_MODE",s,A;function la(){return A||(A=1,s=function r(a,e){if(a===e)return!0;if(a&&e&&typeof a=="object"&&typeof e=="object"){if(a.constructor!==e.constructor)return!1;var n,t,o;if(Array.isArray(a)){if(n=a.length,n!=e.length)return!1;for(t=n;t--!==0;)if(!r(a[t],e[t]))return!1;return!0}if(a.constructor===RegExp)return a.source===e.source&&a.flags===e.flags;if(a.valueOf!==Object.prototype.valueOf)return a.valueOf()===e.valueOf();if(a.toString!==Object.prototype.toString)return a.toString()===e.toString();if(o=Object.keys(a),n=o.length,n!==Object.keys(e).length)return!1;for(t=n;t--!==0;)if(!Object.prototype.hasOwnProperty.call(e,o[t]))return!1;for(t=n;t--!==0;){var l=o[t];if(!r(a[l],e[l]))return!1}return!0}return a!==a&&e!==e}),s}var da=la();const P=R(da);function d(r){"@babel/helpers - typeof";return d=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(a){return typeof a}:function(a){return a&&typeof Symbol=="function"&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},d(r)}var F;function N(r,a){var e=Object.keys(r);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(r);a&&(n=n.filter(function(t){return Object.getOwnPropertyDescriptor(r,t).enumerable})),e.push.apply(e,n)}return e}function T(r){for(var a=1;a<arguments.length;a++){var e=arguments[a]!=null?arguments[a]:{};a%2?N(Object(e),!0).forEach(function(n){ca(r,n,e[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(e)):N(Object(e)).forEach(function(n){Object.defineProperty(r,n,Object.getOwnPropertyDescriptor(e,n))})}return r}function ca(r,a,e){return a=pa(a),a in r?Object.defineProperty(r,a,{value:e,enumerable:!0,configurable:!0,writable:!0}):r[a]=e,r}function pa(r){var a=ma(r,"string");return d(a)==="symbol"?a:String(a)}function ma(r,a){if(d(r)!=="object"||r===null)return r;var e=r[Symbol.toPrimitive];if(e!==void 0){var n=e.call(r,a);if(d(n)!=="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(a==="string"?String:Number)(r)}function c(r){return _a(r)||Fa(r)||sa(r)||ua()}function ua(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function sa(r,a){if(r){if(typeof r=="string")return x(r,a);var e=Object.prototype.toString.call(r).slice(8,-1);if(e==="Object"&&r.constructor&&(e=r.constructor.name),e==="Map"||e==="Set")return Array.from(r);if(e==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e))return x(r,a)}}function Fa(r){if(typeof Symbol<"u"&&r[Symbol.iterator]!=null||r["@@iterator"]!=null)return Array.from(r)}function _a(r){if(Array.isArray(r))return x(r)}function x(r,a){(a==null||a>r.length)&&(a=r.length);for(var e=0,n=new Array(a);e<a;e++)n[e]=r[e];return n}const{global:xa}=__STORYBOOK_MODULE_GLOBAL__,{STORY_CHANGED:za,SET_STORIES:Ra,DOCS_RENDERED:$a}=__STORYBOOK_MODULE_CORE_EVENTS__;var L=xa,ga=L.document,u=L.window,W="sb-addon-themes-3";(F=u.matchMedia)===null||F===void 0||F.call(u,"(prefers-color-scheme: dark)");var g={classTarget:"body",dark:m.dark,darkClass:["dark"],light:m.light,lightClass:["light"],stylePreview:!1,userHasExplicitlySetTheTheme:!1},w=function(a){u.localStorage.setItem(W,JSON.stringify(a))},Sa=function(a,e){var n=e.current,t=e.darkClass,o=t===void 0?g.darkClass:t,l=e.lightClass,S=l===void 0?g.lightClass:l;if(n==="dark"){var y,f;(y=a.classList).remove.apply(y,c(p(S))),(f=a.classList).add.apply(f,c(p(o)))}else{var h,C;(h=a.classList).remove.apply(h,c(p(o))),(C=a.classList).add.apply(C,c(p(S)))}},p=function(a){var e=[];return e.concat(a).map(function(n){return n})},ya=function(a){var e=ga.querySelector(a.classTarget);e&&Sa(e,a)},fa=function(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},e=u.localStorage.getItem(W);if(typeof e=="string"){var n=JSON.parse(e);return a&&(a.dark&&!P(n.dark,a.dark)&&(n.dark=a.dark,w(n)),a.light&&!P(n.light,a.light)&&(n.light=a.light,w(n))),n}return T(T({},g),a)};ya(fa());const{addons:Ia,useState:ja,useEffect:Va}=__STORYBOOK_MODULE_PREVIEW_API__,{useGlobals:ha,addons:Ca}=__STORYBOOK_MODULE_PREVIEW_API__,k=Ca.getChannel();function z(){const[r,a]=_.useState(!1);return _.useEffect(()=>(k.on(B,a),()=>k.off(B,a)),[]),r}const Da=$(["body{background-color:",";}"],M.color.Neutral_Neutral00);function Ea(r){const a=z();_.useEffect(()=>{document.body.classList.add(...(a?b:E).split(" ")),document.body.classList.remove(...(a?E:b).split(" "))},[a]);const e=()=>a?i.jsx(oa,{}):i.jsx(ia,{});return i.jsxs(j,{theme:a?J:q,children:[r.CSSCustomProps&&e(),r.children]})}const ba=I.div.withConfig({displayName:"preview__StoryContainer",componentId:"sc-vmg6hf-0"})(["padding:3em;background-color:",";"],M.color.Neutral_Neutral00),Ua={tags:["autodocs"],parameters:{options:{storySort:{includeName:!0,locales:"en-US",order:["Admiral-2.1",["Date Picker","Range Picker","Double Range Picker","Widgets"]]}},actions:{argTypesRegex:"^on[A-Z].*"},controls:{matchers:{color:/(background|color)$/i,date:/Date$/}},docs:{container:r=>{const a=z()?m.dark:m.normal;return i.jsx(V,{...r,theme:a})}}},decorators:[r=>{const[{CSSCustomProps:a}]=ha();return i.jsxs(Ea,{CSSCustomProps:a,children:[i.jsx(Da,{}),i.jsx(U,{children:i.jsx(ba,{children:r()})})]})},r=>i.jsxs(i.Fragment,{children:[i.jsx(ea,{}),i.jsx(r,{})]})],globalTypes:{CSSCustomProps:{defaultValue:!1,toolbar:{title:"CSS Custom Props",items:[{value:!0,title:"Enable css custom props",icon:"passed"},{value:!1,title:"Disable css custom props",icon:"failed"}]}}}};export{Ua as default};
