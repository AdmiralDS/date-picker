...
}`},description:"",name:"locale",required:!1,type:{name:"CalendarLocaleProps"}},range:{defaultValue:null,description:"",name:"range",required:!1,type:{name:"boolean"}}}}}catch{}const q=`import type { MouseEventHandler } from 'react';
...
`,R={title:"Admiral-2.1/Widgets/DatesOfMonth",component:h,parameters:{docs:{source:{code:null}}},argTypes:{}},F=a=>o.jsx(i,{...a}),s={render:F,parameters:{docs:{source:{code:q}}},name:"DatesOfMonthWidgetSimple"};var f,g,M;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
