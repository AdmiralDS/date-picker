import{j as e}from"./tslib.es6-gXVSDp23.js";import{r as f}from"./index-uubelm5h.js";import{g as Y,r as L}from"./index-BmDKb8-G.js";import{Y as O}from"./index-kpVUKAgH.js";import{S as R,C as z,M as $,Y as G,W as K,d as J,T as h}from"./common-Bv7mrnSY.js";import{Y as A}from"./index-CRcsup42.js";import"./index-CDFRDas0.js";import"./typography.es-zceevOJ_.js";import"./ChevronRightOutline-CZSof5K9.js";import"./index-Dei0BBcc.js";import"./DropdownProvider.es-CSByVTCf.js";import"./index-BK0VveLK.js";import"./index-BwEGqyV7.js";import"./index-DE_Uz_sS.js";import"./index-CnCv02sI.js";import"./index-XsyWP5nu.js";import"./index-EHZnHVT3.js";import"./index-BCJ8Ydv3.js";const s=({viewModeValue:t,defaultViewModeValue:c,onViewModeChange:d,dateValue:p,defaultDateValue:P,onDateValueChange:D,selectedDateValue:S,defaultSelectedDateValue:k,onSelectedDateValueChange:m,cell:l,locale:r=L,prevButtonProps:x,nextButtonProps:g,...V})=>{const[j,q]=f.useState(c||"months"),n=t||j,y=u=>{q(u),d==null||d(u)},[w,T]=f.useState(P||Y(r==null?void 0:r.localeName)),a=p||w,o=u=>{T(u),D==null||D(u)},[b,_]=f.useState(k),B=S||b,W=u=>{_(u),m==null||m(u)},H=u=>{W(u)},I=u=>{const C=a.year(u.year());o(C),y("months")},N=u=>{switch(u.target.dataset.panelTargetType){case"left":o(n==="months"?a.subtract(1,"year"):a.subtract(A,"year"));break;case"right":o(n==="months"?a.add(1,"year"):a.add(A,"year"));break;case"year":y(n==="years"?"months":"years");break}};return e.jsxs(R,{children:[e.jsx(O,{date:a,viewMode:n,locale:r,onClick:N,prevButtonProps:x,nextButtonProps:g}),e.jsxs(z,{children:[e.jsx($,{...V,cell:l==null?void 0:l.monthCell,dateValue:a,selectedDateValue:B,onSelectedDateValueChange:H,locale:r,$isVisible:n==="months"}),e.jsx(G,{...V,cell:l==null?void 0:l.yearCell,dateValue:a,selectedDateValue:B,onSelectedDateValueChange:I,locale:r,$isVisible:n==="years"})]})]})};try{s.displayName="MonthPickerCalendar",s.__docgenInfo={description:"",displayName:"MonthPickerCalendar",props:{locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
