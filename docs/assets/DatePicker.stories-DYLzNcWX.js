...
`,Ce={title:"Admiral-2.1/Date Picker/DatePicker",component:p,parameters:{docs:{source:{language:"tsx"}}},argTypes:{}},D={render:t=>a.jsx(g,{...t}),parameters:{docs:{source:{code:ie}}},name:"Выбор даты",args:{inputProps:{placeholder:"Введите дату",dataPlaceholder:"дд.мм.гггг",value:"11."}}};var B,A,_;D.parameters={...D.parameters,docs:{...(B=D.parameters)==null?void 0:B.docs,source:{originalSource:`{
...
}`,...(_=(A=D.parameters)==null?void 0:A.docs)==null?void 0:_.source}}};const Ie=["DatePickerCalendarSimple"];export{D as DatePickerCalendarSimple,Ie as __namedExportsOrder,Ce as default};
