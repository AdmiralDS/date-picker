import{u as W,j as s}from"./typography.es-y01boJtk.js";import{Y as h}from"./index-BwiDr1EV.js";import{r as i}from"./index-BBkUAzwr.js";import{C as Y,e as E,g as p,a as L,r as H,d as m}from"./index-DmuP904s.js";import{a as _}from"./index-CoxCimnh.js";import"./ChevronRightOutline-Cu42pdAX.js";import"./index-PqR-_bA4.js";import"./DropdownProvider.es-qCbMjVMC.js";const w=W.div`
...
`,l=({locale:e=H,date:f,...y})=>{const C=(e==null?void 0:e.localeName)||"ru",[n,d]=i.useState(f||p(e==null?void 0:e.localeName)),[N,b]=i.useState(p(C).add(1,"day")),[u,T]=i.useState(),c=a=>{T(a)},S=a=>{const t=a.target.dataset;if(t.cellType!=="monthCell")return;const r=m(t.value).locale((e==null?void 0:e.localeName)||"ru");!(t.disabled==="true"||t.hiddenCell==="true")&&!r.isSame(u)&&c(r)},M=a=>{c(void 0)},x=a=>{const t=a.target.dataset;if(t.cellType!=="monthCell")return;const r=m(t.value).locale((e==null?void 0:e.localeName)||"ru");t.disabled==="true"||t.hiddenCell==="true"||b(r)},A=a=>{switch(a.target.dataset.panelTargetType){case"left":d(n.subtract(1,"year"));break;case"right":d(n.add(1,"year"));break}};return s.jsxs(w,{children:[s.jsx(h,{date:n,locale:e,onClick:A}),s.jsx(_,{...y,date:n,selected:N,active:u,locale:e,cell:L,onMouseOver:S,onClick:x,onMouseLeave:M})]})};try{l.displayName="YearNavigationPanelWidgetSimpleTemplate",l.__docgenInfo={description:"",displayName:"YearNavigationPanelWidgetSimpleTemplate",props:{viewMode:{defaultValue:null,description:"",name:"viewMode",required:!1,type:{name:"enum",value:[{value:'"dates"'},{value:'"months"'},{value:'"years"'}]}},date:{defaultValue:null,description:"Дата",name:"date",required:!1,type:{name:"Dayjs"}},locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
`,G={title:"Admiral-2.1/Widgets/YearNavigationPanel",component:h,parameters:{docs:{source:{code:null}}},argTypes:{}},I=e=>s.jsx(l,{...e}),o={render:I,parameters:{docs:{source:{code:j}}},name:"YearNavigationPanelWidgetSimple"};var g,v,D;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
...
}`,...(D=(v=o.parameters)==null?void 0:v.docs)==null?void 0:D.source}}};const z=["YearNavigationPanelWidgetSimple"];export{o as YearNavigationPanelWidgetSimple,z as __namedExportsOrder,G as default};
