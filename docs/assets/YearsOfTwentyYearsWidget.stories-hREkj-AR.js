import{j as l}from"./tslib.es6-gXVSDp23.js";import{b as S,a as Y}from"./index-CRcsup42.js";import{r as p}from"./index-uubelm5h.js";import{p as g,t as O}from"./typography.es-zceevOJ_.js";import{g as x,d as i,c as A,f as _,r as E}from"./index-BmDKb8-G.js";const j=g.div.withConfig({displayName:"YearsOfTwentyYearsWidgetSimple.template__Wrapper",componentId:"sc-ac27e2e-0"})(["display:flex;flex-direction:column;align-items:center;align-content:space-between;padding:10px;width:","px;border:1px "," solid;"],S,a=>a.theme.color["Neutral/Neutral 90"]),I=g.div.withConfig({displayName:"YearsOfTwentyYearsWidgetSimple.template__MonthYear",componentId:"sc-ac27e2e-1"})(["margin-bottom:10px;",""],O["Subtitle/Subtitle 2"]),d=({date:a,locale:e=E,...D})=>{const T=(e==null?void 0:e.localeName)||"ru",u=a||x(e==null?void 0:e.localeName),[v,b]=p.useState(i().locale(T).add(1,"year")),[o,h]=p.useState(),c=n=>{h(n)},M=n=>{const t=n.target.dataset;if(t.cellType!=="yearCell")return;const r=i(t.value).locale((e==null?void 0:e.localeName)||"ru");!(t.disabled==="true"||t.hiddenCell==="true")&&!r.isSame(o)&&c(r)},W=n=>{c(void 0)},w=n=>{const t=n.target.dataset;if(t.cellType!=="yearCell")return;const r=i(t.value).locale((e==null?void 0:e.localeName)||"ru");t.disabled==="true"||t.hiddenCell==="true"||b(r)};return l.jsxs(j,{children:[l.jsxs(I,{children:["Дата: ",A(u.format("D MMMM YYYY"))]}),l.jsx(Y,{...D,date:u,selected:v,active:o,locale:e,cell:_,onMouseLeave:W,onMouseOver:M,onClick:w})]})};try{d.displayName="YearsOfTwentyYearsWidgetSimpleTemplate",d.__docgenInfo={description:"",displayName:"YearsOfTwentyYearsWidgetSimpleTemplate",props:{date:{defaultValue:null,description:"Дата",name:"date",required:!0,type:{name:"Dayjs"}},selected:{defaultValue:null,description:"",name:"selected",required:!1,type:{name:"Dayjs | [Dayjs, Dayjs] | undefined"}},active:{defaultValue:null,description:"",name:"active",required:!1,type:{name:"Dayjs"}},activeRangeEnd:{defaultValue:null,description:"",name:"activeRangeEnd",required:!1,type:{name:"Dayjs"}},dateAttributes:{defaultValue:null,description:"",name:"dateAttributes",required:!1,type:{name:"((currentDate: Dayjs) => DateAttributes)"}},cell:{defaultValue:null,description:"",name:"cell",required:!0,type:{name:"FunctionComponent<DateCellProps>"}},locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
`,k={title:"Admiral-2.1/Widgets/YearsOfTwentyYears",component:Y,parameters:{docs:{source:{code:null}}},argTypes:{}},N=a=>l.jsx(d,{...a}),s={render:N,parameters:{docs:{source:{code:L}}},name:"YearsOfTwentyYearsWidgetSimple"};var m,y,f;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
