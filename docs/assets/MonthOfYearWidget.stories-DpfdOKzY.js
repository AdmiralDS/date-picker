import{j as l}from"./tslib.es6-gXVSDp23.js";import{a as T,M as g}from"./index-DFy_Fcck.js";import{r as p}from"./index-uubelm5h.js";import{p as M,t as x}from"./typography.es-zceevOJ_.js";import{g as _,d as o,c as A,a as j,r as E}from"./index-B-lRfg65.js";const I=M.div.withConfig({displayName:"MonthsOfYearWidgetSimple.template__Wrapper",componentId:"sc-c6543447-0"})(["display:flex;flex-direction:column;align-items:center;align-content:space-between;padding:10px;width:","px;border:1px "," solid;"],T,a=>a.theme.color["Neutral/Neutral 90"]),N=M.div.withConfig({displayName:"MonthsOfYearWidgetSimple.template__MonthYear",componentId:"sc-c6543447-1"})(["margin-bottom:10px;",""],x["Subtitle/Subtitle 2"]),i=({date:a,locale:e=E,...D})=>{const y=(e==null?void 0:e.localeName)||"ru",d=a||_(e==null?void 0:e.localeName),[v,b]=p.useState(o().locale(y).add(1,"day")),Y=n=>{const t=n.target.dataset;if(t.cellType!=="monthCell")return;const r=o(t.value).locale((e==null?void 0:e.localeName)||"ru");t.disabled==="true"||t.hiddenCell==="true"||b(r)},[u,O]=p.useState(),c=n=>{O(n)},W=n=>{const t=n.target.dataset;if(t.cellType!=="monthCell")return;const r=o(t.value).locale((e==null?void 0:e.localeName)||"ru");!(t.disabled==="true"||t.hiddenCell==="true")&&!r.isSame(u)&&c(r)},C=n=>{c(void 0)};return l.jsxs(I,{children:[l.jsxs(N,{children:["Дата: ",A(d.format("D MMMM YYYY"))]}),l.jsx(g,{...D,date:d,selected:v,active:u,locale:e,cell:j,onMouseOver:W,onClick:Y,onMouseLeave:C})]})};try{i.displayName="MonthsOfYearWidgetSimpleTemplate",i.__docgenInfo={description:"",displayName:"MonthsOfYearWidgetSimpleTemplate",props:{date:{defaultValue:null,description:"Дата",name:"date",required:!0,type:{name:"Dayjs"}},selected:{defaultValue:null,description:"",name:"selected",required:!1,type:{name:"Dayjs | [Dayjs, Dayjs] | undefined"}},active:{defaultValue:null,description:"",name:"active",required:!1,type:{name:"Dayjs"}},activeRangeEnd:{defaultValue:null,description:"",name:"activeRangeEnd",required:!1,type:{name:"Dayjs"}},dateAttributes:{defaultValue:null,description:"",name:"dateAttributes",required:!1,type:{name:"((currentDate: Dayjs) => DateAttributes)"}},cell:{defaultValue:null,description:"",name:"cell",required:!0,type:{name:"FunctionComponent<DateCellProps>"}},locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
`,k={title:"Admiral-2.1/Widgets/MonthsOfYear",component:g,parameters:{docs:{source:{code:null}}},argTypes:{}},H=a=>l.jsx(i,{...a}),s={render:H,parameters:{docs:{source:{code:L}}},name:"MonthsOfYearWidgetSimple"};var m,f,h;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
