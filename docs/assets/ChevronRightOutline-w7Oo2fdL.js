import{c as H,p as O,j as m,t as L}from"./typography.es-CjQrIQMn.js";import{r as s}from"./index-CDs2tPxN.js";import{L as j}from"./index-D7UWWCrG.js";import{r as W}from"./index-B-yFm4aN.js";import{D as F}from"./DropdownProvider.es-C-Oh7jsZ.js";var B,T;function C(){return C=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var o=arguments[n];for(var c in o)Object.prototype.hasOwnProperty.call(o,c)&&(e[c]=o[c])}return e},C.apply(this,arguments)}var M=function(e){return s.createElement("svg",C({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},e),B||(B=s.createElement("defs",null,s.createElement("clipPath",{id:"CloseOutline_svg__a"},s.createElement("path",{fill:"#fff",fillOpacity:0,d:"M0 0h24v24H0z"})))),T||(T=s.createElement("g",{clipPath:"url(#CloseOutline_svg__a)"},s.createElement("path",{fill:"#717681",d:"M6.4 5.49a.63.63 0 0 0-.91 0c-.26.25-.26.66 0 .91l5.59 5.59-5.49 5.5c-.26.25-.26.66 0 .91.25.26.66.26.91 0l5.5-5.49 5.49 5.49c.25.26.66.26.91 0 .26-.25.26-.66 0-.91l-5.49-5.5L18.5 6.4c.26-.25.26-.66 0-.91a.63.63 0 0 0-.91 0L12 11.08z"}))))};const D=24,A=20,z=16,q=6,G=4;function P(e){switch(e){case"lSmall":case"lBig":default:return D;case"mSmall":case"mBig":return A;case"s":return z}}function N(e){switch(e){case"lBig":case"mBig":default:return q;case"lSmall":case"mSmall":case"s":return G}}function k(e){return P(e)+2*N(e)}const U=H`
  & *[fill^='#'] {
...
`,K=s.forwardRef(({type:e="button",dimension:n="lBig",disabled:o=!1,highlightFocus:c=!0,appearance:u,children:v,...f},d)=>{const p=typeof u=="object"?u.iconColor?u.iconColor:"secondary":u;return m.jsxs(J,{ref:d,type:e,$dimension:n,disabled:o,$highlightFocus:c,...f,children:[m.jsx(_,{$dimension:n,"aria-hidden":!0}),m.jsx(V,{$dimension:n,$iconColor:p,"aria-hidden":!0,children:v})]})});s.forwardRef(({className:e,...n},o)=>m.jsx(K,{ref:o,className:`close-button ${e||""}`,...n,children:m.jsx(M,{"aria-hidden":!0})}));function I(...e){return n=>{e.forEach(o=>{o&&(typeof o=="function"?o(n):o.current=n)})}}const Q=()=>{let e=0;const n=document.createElement("div");return n.innerHTML=`Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diem 
    nonummy nibh euismod tincidunt ut lacreet dolore magna aliguam erat volutpat. 
    Ut wisis enim ad minim veniam, quis nostrud exerci tution ullamcorper suscipit 
    lobortis nisl ut aliquip ex ea commodo consequat.`,n.style.overflow="scroll",n.style.fontSize="14px",n.style.height="50px",n.style.maxHeight="50px",n.style.width="100px",n.style.position="absolute",n.style.top="-100000px",n.style.left="-100000px",document.body.appendChild(n),e=n.offsetWidth-n.clientWidth,document.body.removeChild(n),e||16},X=["bottom","height","left","right","top","width"];function Z(e,n){const o={};return{observe(){o.rafId&&cancelAnimationFrame(o.rafId);const c=()=>{if(o.isObserving){const{bottom:u,height:v,left:f,right:d,top:p,width:l,x:t,y:i}=e.getBoundingClientRect(),r={bottom:u,height:v,left:f,right:d,top:p,width:l,x:t||f,y:i||p};((a={},h={})=>X.some($=>a[$]!==h[$]))(r,o.rect)&&(o.rect=r,n(o.rect)),o.rafId=requestAnimationFrame(c)}};o.rafId=requestAnimationFrame(c),o.isObserving=!0},unobserve(){o.rafId&&cancelAnimationFrame(o.rafId),o.isObserving&&(o.isObserving=!1)}}}const R=O.div`
  pointer-events: none;
  position: fixed;
  overflow: visible;
  z-index: var(--admiral-z-index-dropdown, ${({theme:e})=>e.zIndex.dropdown});
`,ee=({targetRef:e,targetElement:n,rootRef:o,fullContainerWidth:c,...u})=>{const v=s.useRef(null);return s.useEffect(()=>{const f=v.current,d=n??(e==null?void 0:e.current);if(f&&d){const p=Z(d,l=>{if(l){const{x:t,y:i,height:r,width:a}=l,{style:h}=f;h.top=`${i}px`,h.left=c?"0px":`${t}px`,h.height=`${r}px`,h.width=c?"100%":`${a}px`}});return p.observe(),()=>{p.unobserve()}}},[e,n,c]),W.createPortal(m.jsx(R,{ref:v,...u}),(o==null?void 0:o.current)||document.body)},te=e=>{let n=e;return n=n.replace("box-shadow: ",""),n=n.replace(";",""),n},ie=O.div`
  box-sizing: border-box;
  opacity: 0;
...
`,ne=O.div`
  ...
  ${e=>e.$dimension==="m"?L["Body/Body 2 Short"]:L["Caption/Caption 1"]}
