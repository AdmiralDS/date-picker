import{p as Y,t as S,j as l}from"./typography.es-CjQrIQMn.js";import{b as O,a as g}from"./index-CEadLOe1.js";import{r as p}from"./index-CDs2tPxN.js";import{g as x,d as i,c as A,f as _,r as E}from"./index-D7UWWCrG.js";import"./tslib.es6-CRos2fHm.js";const j=Y.div.withConfig({displayName:"YearsOfTwentyYearsWidgetSimple.template__Wrapper",componentId:"sc-7443e259-0"})(["display:flex;flex-direction:column;align-items:center;align-content:space-between;padding:10px;width:","px;border:1px "," solid;"],O,a=>a.theme.color["Neutral/Neutral 90"]),I=Y.div.withConfig({displayName:"YearsOfTwentyYearsWidgetSimple.template__MonthYear",componentId:"sc-7443e259-1"})(["margin-bottom:10px;",""],S["Subtitle/Subtitle 2"]),o=({date:a,locale:e=E,...D})=>{const T=(e==null?void 0:e.localeName)||"ru",d=a||x(e==null?void 0:e.localeName),[v,b]=p.useState(i().locale(T).add(1,"year")),[u,h]=p.useState(),c=n=>{h(n)},M=n=>{const t=n.target.dataset;if(t.cellType!=="yearCell")return;const r=i(t.value).locale((e==null?void 0:e.localeName)||"ru");!(t.disabled==="true"||t.hiddenCell==="true")&&!r.isSame(u)&&c(r)},W=n=>{c(void 0)},w=n=>{const t=n.target.dataset;if(t.cellType!=="yearCell")return;const r=i(t.value).locale((e==null?void 0:e.localeName)||"ru");t.disabled==="true"||t.hiddenCell==="true"||b(r)};return l.jsxs(j,{children:[l.jsxs(I,{children:["Дата: ",A(d.format("D MMMM YYYY"))]}),l.jsx(g,{...D,date:d,selected:v,active:u,locale:e,cell:_,onMouseLeave:W,onMouseOver:M,onClick:w})]})};try{o.displayName="YearsOfTwentyYearsWidgetSimpleTemplate",o.__docgenInfo={description:"",displayName:"YearsOfTwentyYearsWidgetSimpleTemplate",props:{date:{defaultValue:null,description:"Дата",name:"date",required:!0,type:{name:"Dayjs"}},selected:{defaultValue:null,description:"",name:"selected",required:!1,type:{name:"Dayjs | [Dayjs, Dayjs] | undefined"}},active:{defaultValue:null,description:"",name:"active",required:!1,type:{name:"Dayjs"}},activeRangeEnd:{defaultValue:null,description:"",name:"activeRangeEnd",required:!1,type:{name:"Dayjs"}},dateAttributes:{defaultValue:null,description:"",name:"dateAttributes",required:!1,type:{name:"((currentDate: Dayjs) => DateAttributes)"}},cell:{defaultValue:null,description:"",name:"cell",required:!0,type:{name:"FunctionComponent<DateCellProps>"}},locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
`,k={title:"Admiral-2.1/Widgets/YearsOfTwentyYears",component:g,parameters:{docs:{source:{code:null}}},argTypes:{}},N=a=>l.jsx(o,{...a}),s={render:N,parameters:{docs:{source:{code:L}}},name:"YearsOfTwentyYearsWidgetSimple"};var m,y,f;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(f=(y=s.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};const B=["YearsOfTwentyYearsWidgetSimple"];export{s as YearsOfTwentyYearsWidgetSimple,B as __namedExportsOrder,k as default};
