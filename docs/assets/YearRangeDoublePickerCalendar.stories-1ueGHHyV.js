...
`,h={title:"Admiral-2.1/Double Range Picker/YearRangeDoublePickerCalendar",component:o,parameters:{docs:{source:{code:null}},design:{type:"figma",url:"https://www.figma.com/file/EGEGZsx8WhdxpmFKu8J41G/Admiral-2.1-UI-Kit?node-id=39%3A53407"}},argTypes:{locale:{control:!1}}},f=e=>u.jsx(r,{...e}),a={render:f,parameters:{docs:{source:{code:m}}},name:"Сдвоенный календарь выбора лет"};var t,n,i;a.parameters={...a.parameters,docs:{...(t=a.parameters)==null?void 0:t.docs,source:{originalSource:`{
...
}`,...(i=(n=a.parameters)==null?void 0:n.docs)==null?void 0:i.source}}};const T=["YearRangeDoublePickerCalendarSimple"];export{a as YearRangeDoublePickerCalendarSimple,T as __namedExportsOrder,h as default};
