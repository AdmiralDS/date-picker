import{j as u}from"./typography.es-DJ4WRfsu.js";import{S as T,C as j,l as q}from"./index-DUrvFc95.js";import{r as m}from"./index-RYns6xqu.js";import{g as Y,r as b}from"./index-DnXc0ZDD.js";import{T as _}from"./index-D4_0Szhj.js";import{Y as f}from"./index-CMIGvJsC.js";import{W as w,a as W,T as E}from"./common-C0nfkXAM.js";import"./index-rLJdUzAE.js";import"./ChevronRightOutline-4h1Amxbj.js";import"./index-BQaZqJLe.js";import"./DropdownProvider.es-DMHOw4-n.js";import"./index-DisOlbzP.js";import"./index-DjVRa9xT.js";const i=({dateValue:e,defaultDateValue:d,onDateValueChange:t,selectedDateRangeValue:s,defaultSelectedDateRangeValue:C,onSelectedDateRangeValueChange:o,cell:c,locale:r=b,prevButtonProps:V,nextButtonProps:A,...F})=>{const[R,v]=m.useState(d||Y(r==null?void 0:r.localeName)),l=e||R,D=a=>{v(a),t==null||t(a)},[P,k]=m.useState(C),x=s||P,h=a=>{k(a),o==null||o(a)},S=a=>{switch(a.target.dataset.panelTargetType){case"left":D(l.subtract(f,"year"));break;case"right":D(l.add(f,"year"));break}};return u.jsxs(T,{children:[u.jsx(_,{date:l,viewMode:"years",locale:r,onClick:S,prevButtonProps:V,nextButtonProps:A}),u.jsx(j,{children:u.jsx(q,{...F,cell:c==null?void 0:c.yearCell,dateValue:l,selectedDateRangeValue:x,onSelectedDateRangeValueChange:h,locale:r,$isVisible:!0})})]})};try{i.displayName="YearRangePickerCalendar",i.__docgenInfo={description:"",displayName:"YearRangePickerCalendar",props:{locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
}`,...(y=(B=n.parameters)==null?void 0:B.docs)==null?void 0:y.source}}};const a4=["YearRangePickerCalendarSimple"];export{n as YearRangePickerCalendarSimple,a4 as __namedExportsOrder,e4 as default};
