import{j as e}from"./typography.es-DJ4WRfsu.js";import{i as Q,j as S,C as k,l as j}from"./index-DUrvFc95.js";import{r as s}from"./index-RYns6xqu.js";import{g as X,u as P,r as uu}from"./index-DnXc0ZDD.js";import{T as x}from"./index-D4_0Szhj.js";import{Y as d}from"./index-CMIGvJsC.js";import{W as eu,a as au,T}from"./common-C0nfkXAM.js";import"./index-rLJdUzAE.js";import"./ChevronRightOutline-4h1Amxbj.js";import"./index-BQaZqJLe.js";import"./DropdownProvider.es-DMHOw4-n.js";import"./index-DisOlbzP.js";import"./index-DjVRa9xT.js";const D=({dateRangeValue:a,defaultDateRangeValue:n,onDateRangeValueChange:l,selectedDateRangeValue:p,defaultSelectedDateRangeValue:w,onSelectedDateRangeValueChange:m,activeDateValue:L,defaultActiveDateValue:W,onActiveDateValueChange:f,cell:o,locale:i=uu,prevButtonProps:C,nextButtonProps:B,...A})=>{const[N,H]=s.useState((n==null?void 0:n[0])||X(i==null?void 0:i.localeName)),t=(a==null?void 0:a[0])||N,E=u=>{H(u),l==null||l([u,r])},[M,I]=s.useState((n==null?void 0:n[1])||t.add(d,"year")),r=(a==null?void 0:a[1])||M,y=u=>{I(u),l==null||l([t,u])};s.useEffect(()=>{P(t,r,"year")&&y(t.add(d,"year"))},[t]),s.useEffect(()=>{P(r,t,"year")&&E(r.subtract(d,"year"))},[r]);const[z,$]=s.useState(W),v=L||z,F=u=>{$(u),f==null||f(u)},[G,O]=s.useState(w),V=p||G,R=u=>{O(u),m==null||m(u)},[b,Z]=s.useState(),h=u=>{Z(u)},K=u=>{switch(u.target.dataset.panelTargetType){case"left":E(t.subtract(d,"year"));break;case"right":E(t.add(d,"year"));break}},J=u=>{switch(u.target.dataset.panelTargetType){case"left":y(r.subtract(d,"year"));break;case"right":y(r.add(d,"year"));break}};return e.jsxs(Q,{children:[e.jsxs(S,{children:[e.jsx(x,{date:t,viewMode:"years",locale:i,onClick:K,prevButtonProps:C,nextButtonProps:B}),e.jsx(k,{children:e.jsx(j,{...A,cell:o==null?void 0:o.yearCell,dateValue:t,selectedDateRangeValue:V,onSelectedDateRangeValueChange:R,activeDateValue:v,onActiveDateValueChange:F,activeDateRangeEndValue:b,onActiveDateRangeEndValueChange:h,locale:i,$isVisible:!0})})]}),e.jsxs(S,{children:[e.jsx(x,{date:r,viewMode:"years",locale:i,onClick:J,prevButtonProps:C,nextButtonProps:B}),e.jsx(k,{children:e.jsx(j,{...A,cell:o==null?void 0:o.yearCell,dateValue:r,selectedDateRangeValue:V,onSelectedDateRangeValueChange:R,activeDateValue:v,onActiveDateValueChange:F,activeDateRangeEndValue:b,onActiveDateRangeEndValueChange:h,locale:i,$isVisible:!0})})]})]})};try{D.displayName="YearRangeDoublePickerCalendar",D.__docgenInfo={description:"",displayName:"YearRangeDoublePickerCalendar",props:{locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
}`,...(_=(Y=c.parameters)==null?void 0:Y.docs)==null?void 0:_.source}}};const Cu=["YearRangeDoublePickerCalendarSimple"];export{c as YearRangeDoublePickerCalendarSimple,Cu as __namedExportsOrder,gu as default};
