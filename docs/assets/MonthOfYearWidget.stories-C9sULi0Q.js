...
`,V={title:"Admiral-2.1/Widgets/MonthsOfYear",component:M,parameters:{docs:{source:{code:null}}},argTypes:{}},H=a=>l.jsx(i,{...a}),s={render:H,parameters:{docs:{source:{code:L}}},name:"MonthsOfYearWidgetSimple"};var m,f,h;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(h=(f=s.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};const k=["MonthsOfYearWidgetSimple"];export{s as MonthsOfYearWidgetSimple,k as __namedExportsOrder,V as default};
