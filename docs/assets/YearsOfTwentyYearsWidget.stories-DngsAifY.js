import{p as Y,j as l}from"./styled-components.browser.esm-DrTmyIAt.js";import{Y as g}from"./index-BtwVaLhF.js";import{r as p}from"./index-CDs2tPxN.js";import{d as o}from"./ru-lGojcqRe.js";import{g as S,l as O}from"./utils-B_ZJ_ERX.js";import{c as x}from"./constants-C6vCpwtL.js";import{e as A,r as _}from"./index-OutMbp73.js";import{t as E}from"./typography.es-DSm7pTxC.js";import"./tslib.es6-CRos2fHm.js";import"./mixins-CGQ4MruR.js";const j=Y.div.withConfig({displayName:"YearsOfTwentyYearsWidgetSimple.template__Wrapper",componentId:"sc-7443e259-0"})(["display:flex;flex-direction:column;align-items:center;align-content:space-between;padding:10px;width:","px;border:1px "," solid;"],x,a=>a.theme.color["Neutral/Neutral 90"]),I=Y.div.withConfig({displayName:"YearsOfTwentyYearsWidgetSimple.template__MonthYear",componentId:"sc-7443e259-1"})(["margin-bottom:10px;",""],E["Subtitle/Subtitle 2"]),i=({date:a,locale:e=_,...D})=>{const T=(e==null?void 0:e.localeName)||"ru",d=a||S(e==null?void 0:e.localeName),[v,h]=p.useState(o().locale(T).add(1,"year")),[u,b]=p.useState(),c=n=>{b(n)},M=n=>{const t=n.target.dataset;if(t.cellType!=="yearCell")return;const r=o(t.value).locale((e==null?void 0:e.localeName)||"ru");!(t.disabled==="true"||t.hiddenCell==="true")&&!r.isSame(u)&&c(r)},W=n=>{c(void 0)},w=n=>{const t=n.target.dataset;if(t.cellType!=="yearCell")return;const r=o(t.value).locale((e==null?void 0:e.localeName)||"ru");t.disabled==="true"||t.hiddenCell==="true"||h(r)};return l.jsxs(j,{children:[l.jsxs(I,{children:["Дата: ",O(d.format("D MMMM YYYY"))]}),l.jsx(g,{...D,date:d,selected:v,active:u,locale:e,cell:A,onMouseLeave:W,onMouseOver:M,onClick:w})]})};try{i.displayName="YearsOfTwentyYearsWidgetSimpleTemplate",i.__docgenInfo={description:"",displayName:"YearsOfTwentyYearsWidgetSimpleTemplate",props:{date:{defaultValue:null,description:"Дата",name:"date",required:!0,type:{name:"Dayjs"}},selected:{defaultValue:null,description:"",name:"selected",required:!1,type:{name:"Dayjs | [Dayjs, Dayjs] | undefined"}},active:{defaultValue:null,description:"",name:"active",required:!1,type:{name:"Dayjs"}},activeRangeEnd:{defaultValue:null,description:"",name:"activeRangeEnd",required:!1,type:{name:"Dayjs"}},dateAttributes:{defaultValue:null,description:"",name:"dateAttributes",required:!1,type:{name:"((currentDate: Dayjs) => DateAttributes)"}},cell:{defaultValue:null,description:"",name:"cell",required:!0,type:{name:"FunctionComponent<DateCellProps>"}},locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
`,$={title:"Admiral-2.1/Widgets/YearsOfTwentyYears",component:g,parameters:{docs:{source:{code:null}}},argTypes:{}},N=a=>l.jsx(i,{...a}),s={render:N,parameters:{docs:{source:{code:L}}},name:"YearsOfTwentyYearsWidgetSimple"};var m,y,f;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(f=(y=s.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};const J=["YearsOfTwentyYearsWidgetSimple"];export{s as YearsOfTwentyYearsWidgetSimple,J as __namedExportsOrder,$ as default};
