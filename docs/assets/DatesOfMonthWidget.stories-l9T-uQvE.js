import{p as y,t as A,j as o}from"./typography.es-CjQrIQMn.js";import{a as N,D as h}from"./index-CB9F3xGI.js";import{r as p}from"./index-CDs2tPxN.js";import{d as m}from"./ru-lGojcqRe.js";import{g as D,l as I}from"./utils-B_ZJ_ERX.js";import{b as E}from"./mixins-0kl9vljp.js";import{b as j,r as L}from"./index-B0XozSxi.js";import"./tslib.es6-CRos2fHm.js";const H=y.div.withConfig({displayName:"DatesOfMonthWidgetSimple.template__Wrapper",componentId:"sc-20acd82e-0"})(["display:flex;flex-direction:column;align-items:center;align-content:space-between;padding:10px;width:","px;border:1px "," solid;"],N,a=>a.theme.color["Neutral/Neutral 90"]),Y=y.div.withConfig({displayName:"DatesOfMonthWidgetSimple.template__MonthYear",componentId:"sc-20acd82e-1"})(["margin-bottom:10px;",""],A["Subtitle/Subtitle 2"]),i=({date:a,locale:n=L,...C})=>{const r=(n==null?void 0:n.localeName)||"ru",d=a||D(r),[v,b]=p.useState(D(r).add(1,"day")),x=t=>{const e=t.target.dataset;if(e.cellType!=="dateCell")return;const l=m(e.value).locale(r);e.disabled==="true"||e.hiddenCell==="true"||b(l)},[u,S]=p.useState(),c=t=>{S(t)},O=t=>{const e=t.target.dataset;if(e.cellType!=="dateCell")return;const l=m(e.value).locale(r);console.log(`hiddenCell-${e.hiddenCell}`),!(e.disabled==="true"||e.hiddenCell==="true")&&!l.isSame(u)&&c(l)},T=t=>{c(void 0)},W=t=>({cellMixin:E});return o.jsxs(H,{children:[o.jsxs(Y,{children:["Дата: ",I(d.format("D MMMM YYYY"))]}),o.jsx(h,{...C,date:d,selected:v,active:u,locale:n,cell:j,onMouseLeave:T,onMouseOver:O,onClick:x,dayNamesProps:{dayNameCellState:W}})]})};try{i.displayName="DatesOfMonthWidgetSimpleTemplate",i.__docgenInfo={description:"",displayName:"DatesOfMonthWidgetSimpleTemplate",props:{dayNamesProps:{defaultValue:null,description:"",name:"dayNamesProps",required:!0,type:{name:"DayNameCellProps"}},date:{defaultValue:null,description:"Дата",name:"date",required:!0,type:{name:"Dayjs"}},selected:{defaultValue:null,description:"",name:"selected",required:!1,type:{name:"Dayjs | [Dayjs, Dayjs] | undefined"}},active:{defaultValue:null,description:"",name:"active",required:!1,type:{name:"Dayjs"}},activeRangeEnd:{defaultValue:null,description:"",name:"activeRangeEnd",required:!1,type:{name:"Dayjs"}},dateAttributes:{defaultValue:null,description:"",name:"dateAttributes",required:!1,type:{name:"((currentDate: Dayjs) => DateAttributes)"}},cell:{defaultValue:null,description:"",name:"cell",required:!0,type:{name:"FunctionComponent<DateCellProps>"}},locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
`,G={title:"Admiral-2.1/Widgets/DatesOfMonth",component:h,parameters:{docs:{source:{code:null}}},argTypes:{}},P=a=>o.jsx(i,{...a}),s={render:P,parameters:{docs:{source:{code:F}}},name:"DatesOfMonthWidgetSimple"};var f,g,M;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
...
}`,...(M=(g=s.parameters)==null?void 0:g.docs)==null?void 0:M.source}}};const J=["DatesOfMonthWidgetSimple"];export{s as DatesOfMonthWidgetSimple,J as __namedExportsOrder,G as default};
