import{p as h,j as n}from"./styled-components.browser.esm-DrTmyIAt.js";import{S as j,a as I}from"./ChevronRightOutline-BdJC7GCW.js";import{C as b,r as Y,d as L,e as H}from"./index-OutMbp73.js";import{g as v,y as B}from"./utils-B_ZJ_ERX.js";import{a as T}from"./constants-C6vCpwtL.js";import{t as R}from"./typography.es-DSm7pTxC.js";import{T as k,I as O}from"./index.es-n1eWmiMq.js";import{r as y}from"./index-CDs2tPxN.js";import{d as D}from"./ru-lGojcqRe.js";import{Y as F}from"./index-BtwVaLhF.js";import"./tslib.es6-CRos2fHm.js";import"./mixins-CGQ4MruR.js";import"./index-B-yFm4aN.js";import"./DropdownProvider.es-BaHm9Kb7.js";const q=h.div.withConfig({displayName:"TwentyYearsNavigationPanelWidget__TwentyYearsNavigationPanelWrapper",componentId:"sc-b015cadc-0"})(["box-sizing:border-box;width:","PX;height:32px;padding:0 12px;display:flex;justify-content:space-between;"],b),V=h.div.withConfig({displayName:"TwentyYearsNavigationPanelWidget__TwentyYearsWrapper",componentId:"sc-b015cadc-1"})(["padding:4px 8px;color:",";cursor:default;",""],e=>e.theme.color["Neutral/Neutral 90"],R["Subtitle/Subtitle 2"]),N=k(O),p=({viewMode:e,date:i,locale:t=Y,prevButtonProps:c,nextButtonProps:s,...o})=>{const m=(i==null?void 0:i.locale(t==null?void 0:t.localeName))||v(t==null?void 0:t.localeName),{start:g,end:u}=B(m,T);return n.jsxs(q,{...o,children:[n.jsx(N,{dimension:"lSmall",highlightFocus:!1,"data-panel-target-type":"left",renderContent:()=>t==null?void 0:t.localeText.backwardText,...c,children:n.jsx(j,{})}),n.jsx(V,{children:`${g}–${u}`}),n.jsx(N,{dimension:"lSmall",highlightFocus:!1,"data-panel-target-type":"right",renderContent:()=>t==null?void 0:t.localeText.forwardText,...s,children:n.jsx(I,{})})]})};try{p.displayName="TwentyYearsNavigationPanelWidget",p.__docgenInfo={description:"",displayName:"TwentyYearsNavigationPanelWidget",props:{viewMode:{defaultValue:null,description:"",name:"viewMode",required:!1,type:{name:"enum",value:[{value:'"dates"'},{value:'"months"'},{value:'"years"'}]}},date:{defaultValue:null,description:"Дата",name:"date",required:!1,type:{name:"Dayjs"}},locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
}`,...(S=(C=d.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};const le=["TwentyYearsNavigationPanelWidgetSimple"];export{d as TwentyYearsNavigationPanelWidgetSimple,le as __namedExportsOrder,ue as default};
