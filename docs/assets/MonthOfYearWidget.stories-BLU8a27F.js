import{p as g,t as T,j as o}from"./typography.es-CjQrIQMn.js";import{M as x,a as M}from"./index-5_C4kZbb.js";import{r as p}from"./index-CDs2tPxN.js";import{g as _,d as l,c as A,a as j,r as E}from"./index-D7UWWCrG.js";import"./tslib.es6-CRos2fHm.js";const I=g.div.withConfig({displayName:"MonthsOfYearWidgetSimple.template__Wrapper",componentId:"sc-6e6b54f7-0"})(["display:flex;flex-direction:column;align-items:center;align-content:space-between;padding:10px;width:","px;border:1px "," solid;"],x,a=>a.theme.color["Neutral/Neutral 90"]),N=g.div.withConfig({displayName:"MonthsOfYearWidgetSimple.template__MonthYear",componentId:"sc-6e6b54f7-1"})(["margin-bottom:10px;",""],T["Subtitle/Subtitle 2"]),i=({date:a,locale:e=E,...D})=>{const y=(e==null?void 0:e.localeName)||"ru",d=a||_(e==null?void 0:e.localeName),[v,b]=p.useState(l().locale(y).add(1,"day")),Y=n=>{const t=n.target.dataset;if(t.cellType!=="monthCell")return;const r=l(t.value).locale((e==null?void 0:e.localeName)||"ru");t.disabled==="true"||t.hiddenCell==="true"||b(r)},[u,O]=p.useState(),c=n=>{O(n)},W=n=>{const t=n.target.dataset;if(t.cellType!=="monthCell")return;const r=l(t.value).locale((e==null?void 0:e.localeName)||"ru");!(t.disabled==="true"||t.hiddenCell==="true")&&!r.isSame(u)&&c(r)},C=n=>{c(void 0)};return o.jsxs(I,{children:[o.jsxs(N,{children:["Дата: ",A(d.format("D MMMM YYYY"))]}),o.jsx(M,{...D,date:d,selected:v,active:u,locale:e,cell:j,onMouseOver:W,onClick:Y,onMouseLeave:C})]})};try{i.displayName="MonthsOfYearWidgetSimpleTemplate",i.__docgenInfo={description:"",displayName:"MonthsOfYearWidgetSimpleTemplate",props:{date:{defaultValue:null,description:"Дата",name:"date",required:!0,type:{name:"Dayjs"}},selected:{defaultValue:null,description:"",name:"selected",required:!1,type:{name:"Dayjs | [Dayjs, Dayjs] | undefined"}},active:{defaultValue:null,description:"",name:"active",required:!1,type:{name:"Dayjs"}},activeRangeEnd:{defaultValue:null,description:"",name:"activeRangeEnd",required:!1,type:{name:"Dayjs"}},dateAttributes:{defaultValue:null,description:"",name:"dateAttributes",required:!1,type:{name:"((currentDate: Dayjs) => DateAttributes)"}},cell:{defaultValue:null,description:"",name:"cell",required:!0,type:{name:"FunctionComponent<DateCellProps>"}},locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
`,k={title:"Admiral-2.1/Widgets/MonthsOfYear",component:M,parameters:{docs:{source:{code:null}}},argTypes:{}},H=a=>o.jsx(i,{...a}),s={render:H,parameters:{docs:{source:{code:L}}},name:"MonthsOfYearWidgetSimple"};var m,f,h;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(h=(f=s.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};const B=["MonthsOfYearWidgetSimple"];export{s as MonthsOfYearWidgetSimple,B as __namedExportsOrder,k as default};
