import{j as m}from"./tslib.es6-gXVSDp23.js";import{r as h}from"./index-uubelm5h.js";import{c as j,p as y,t as L}from"./typography.es-zceevOJ_.js";import{L as N}from"./index-B-lRfg65.js";import{r as W}from"./index-Dei0BBcc.js";import{D as F}from"./DropdownProvider.es-CSByVTCf.js";var T;function C(){return C=Object.assign?Object.assign.bind():function(t){for(var i=1;i<arguments.length;i++){var n=arguments[i];for(var u in n)({}).hasOwnProperty.call(n,u)&&(t[u]=n[u])}return t},C.apply(null,arguments)}var _=function(t){return h.createElement("svg",C({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},t),T||(T=h.createElement("path",{fill:"#717681",d:"M6.4 5.49a.63.63 0 0 0-.91 0c-.26.25-.26.66 0 .91l5.59 5.59-5.49 5.5c-.26.25-.26.66 0 .91.25.26.66.26.91 0l5.5-5.49 5.49 5.49c.25.26.66.26.91 0 .26-.25.26-.66 0-.91l-5.49-5.5L18.5 6.4c.26-.25.26-.66 0-.91a.63.63 0 0 0-.91 0L12 11.08z"})))};const M=24,D=20,A=16,q=6,z=4;function B(t){switch(t){case"lSmall":case"lBig":default:return M;case"mSmall":case"mBig":return D;case"s":return A}}function H(t){switch(t){case"lBig":case"mBig":default:return q;case"lSmall":case"mSmall":case"s":return z}}function k(t){return B(t)+2*H(t)}const G=j`
  & *[fill^='#'] {
...
`,U=y.div`
  ...
  & > svg {
    height: ${t=>B(t.$dimension)}px;
    width: ${t=>B(t.$dimension)}px;
  }
`,P=y.div`
...
`,J=h.forwardRef(({type:t="button",dimension:i="lBig",disabled:n=!1,highlightFocus:u=!0,appearance:c,children:x,...p},d)=>{const f=typeof c=="object"?c.iconColor?c.iconColor:"secondary":c;return m.jsxs(Y,{ref:d,type:t,$dimension:i,disabled:n,$highlightFocus:u,...p,children:[m.jsx(P,{$dimension:i,"aria-hidden":!0}),m.jsx(U,{$dimension:i,$iconColor:f,"aria-hidden":!0,children:x})]})});h.forwardRef(({className:t,...i},n)=>m.jsx(J,{ref:n,className:`close-button ${t||""}`,...i,children:m.jsx(_,{"aria-hidden":!0})}));function I(...t){return i=>{t.forEach(n=>{n&&(typeof n=="function"?n(i):n.current=i)})}}const K=()=>{let t=0;const i=document.createElement("div");return i.innerHTML=`Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diem 
...
`,ot=y.div`
  ...
  ${t=>t.$dimension==="m"?L["Body/Body 2 Short"]:L["Caption/Caption 1"]}
