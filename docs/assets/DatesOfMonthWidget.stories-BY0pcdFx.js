import{j as o}from"./tslib.es6-gXVSDp23.js";import{a as A,D as y}from"./index-CEeWF_8x.js";import{r as p}from"./index-uubelm5h.js";import{g as m,c as N,M as I,r as E,d as D,b as j}from"./index-B-lRfg65.js";import{p as h,t as L}from"./typography.es-zceevOJ_.js";const H=h.div.withConfig({displayName:"DatesOfMonthWidgetSimple.template__Wrapper",componentId:"sc-a602df16-0"})(["display:flex;flex-direction:column;align-items:center;align-content:space-between;padding:10px;width:","px;border:1px "," solid;"],A,a=>a.theme.color["Neutral/Neutral 90"]),Y=h.div.withConfig({displayName:"DatesOfMonthWidgetSimple.template__MonthYear",componentId:"sc-a602df16-1"})(["margin-bottom:10px;",""],L["Subtitle/Subtitle 2"]),i=({date:a,locale:n=E,...b})=>{const l=(n==null?void 0:n.localeName)||"ru",d=a||m(l),[C,v]=p.useState(m(l).add(1,"day")),x=t=>{const e=t.target.dataset;if(e.cellType!=="dateCell")return;const r=D(e.value).locale(l);e.disabled==="true"||e.hiddenCell==="true"||v(r)},[u,S]=p.useState(),c=t=>{S(t)},O=t=>{const e=t.target.dataset;if(e.cellType!=="dateCell")return;const r=D(e.value).locale(l);console.log(`hiddenCell-${e.hiddenCell}`),!(e.disabled==="true"||e.hiddenCell==="true")&&!r.isSame(u)&&c(r)},T=t=>{c(void 0)},W=t=>({cellMixin:j});return o.jsxs(H,{children:[o.jsxs(Y,{children:["Дата: ",N(d.format("D MMMM YYYY"))]}),o.jsx(y,{...b,date:d,selected:C,active:u,locale:n,cell:I,onMouseLeave:T,onMouseOver:O,onClick:x,dayNamesProps:{dayNameCellState:W}})]})};try{i.displayName="DatesOfMonthWidgetSimpleTemplate",i.__docgenInfo={description:"",displayName:"DatesOfMonthWidgetSimpleTemplate",props:{dayNamesProps:{defaultValue:null,description:"",name:"dayNamesProps",required:!0,type:{name:"DayNameCellProps"}},date:{defaultValue:null,description:"Дата",name:"date",required:!0,type:{name:"Dayjs"}},selected:{defaultValue:null,description:"",name:"selected",required:!1,type:{name:"Dayjs | [Dayjs, Dayjs] | undefined"}},active:{defaultValue:null,description:"",name:"active",required:!1,type:{name:"Dayjs"}},activeRangeEnd:{defaultValue:null,description:"",name:"activeRangeEnd",required:!1,type:{name:"Dayjs"}},dateAttributes:{defaultValue:null,description:"",name:"dateAttributes",required:!1,type:{name:"((currentDate: Dayjs) => DateAttributes)"}},cell:{defaultValue:null,description:"",name:"cell",required:!0,type:{name:"FunctionComponent<DateCellProps>"}},locale:{defaultValue:{value:`{
  localeName: 'ru',
  localeText: {
    backwardText: 'Назад',
    forwardText: 'Вперед',
...
`,$={title:"Admiral-2.1/Widgets/DatesOfMonth",component:y,parameters:{docs:{source:{code:null}}},argTypes:{}},P=a=>o.jsx(i,{...a}),s={render:P,parameters:{docs:{source:{code:F}}},name:"DatesOfMonthWidgetSimple"};var f,g,M;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
