...
const Template3: StoryFn<typeof Calendar> = ({
  range,
  ...args
}: CalendarPropType) => {
  const [selected, setSelected] = useState<Date | null>(null);
...
const Template4: StoryFn<typeof Calendar> = ({
  range,
  ...args
}: CalendarPropType) => {
  const [selected, setSelected] = useState<Date | null>(null);
...
const Template5: StoryFn<typeof Calendar> = ({
  range,
  ...args
}: CalendarPropType) => {
  const [selected, setSelected] = useState<Date | null>(null);
...
const Template6: StoryFn<typeof Calendar> = ({
  range,
  ...args
}: CalendarPropType) => {
  const [selected, setSelected] = useState<Date | null>(null);
...
const Template7: StoryFn<typeof Calendar> = ({
  range,
  ...args
}: CalendarPropType) => {
  const [selected, setSelected] = useState<Date | null>(null);
...
const Template8: StoryFn<typeof Calendar> = ({
  range,
  ...args
}: CalendarPropType) => {
  const [selected, setSelected] = useState<Date | null>(null);
